    ...
    <div className="mx-auto max-w-7xl space-y-8 pb-12">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3 lg:gap-8">
        ...
        <div className="flex flex-col gap-6 lg:col-span-1">
          ...
          {/* Card 4: Action Buttons (ย้ายมาไว้ฝั่งขวาล่างสุด) */}
          <div className="rounded-3xl bg-slate-50 p-6 border border-slate-100 flex flex-col gap-3">
            <Button type="button" className="h-11 w-full rounded-2xl bg-blue-600 text-white shadow-sm hover:bg-blue-700">
              <Printer className="mr-2 h-4 w-4" /> Print order
            </Button>
            <Button type="button" variant="outline" className="h-11 w-full rounded-2xl bg-white font-medium text-slate-900 shadow-sm border-slate-200 hover:bg-slate-50">
