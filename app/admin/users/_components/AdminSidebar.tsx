          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive ? "bg-purple-50 text-purple-700 shadow-sm" : "text-gray-600 hover:bg-gray-50 hover:text-gray-900"
              )}
            >
              <Icon
                className={cn("mr-3 h-5 w-5 transition-colors", isActive ? "text-purple-600" : "text-gray-400 group-hover:text-gray-500")}
              />
              {link.label}
            </Link>
          );
